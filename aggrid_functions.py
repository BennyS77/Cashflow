  ...
  gridOptions={
    ...
    "columnDefs": [
      ...
      },
      {
        ...
        "maxWidth": 200,
        "headerTooltip":"Costs up to the Reporting Month compared to estimated final cost. ie 'Actual Cost To Date' / 'Estimate At Completion' ",
